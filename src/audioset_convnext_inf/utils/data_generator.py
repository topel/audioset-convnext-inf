...
from audioset_convnext_inf.pytorch.augmentations import SpeedPerturbation
from audioset_convnext_inf.utils.utilities import int16_to_float32
    ...
    def __getitem__(self, meta):
        ...
        with h5py.File(hdf5_path, "r") as hf:
            ...
            if self.use_torchaudio:
                ...
                data_dict = {"audio_name": audio_name, "target": target, "fbank": fbank}
            else:
                data_dict = {
...
def collate_fn(list_data_dict):
    ...
    for key in list_data_dict[0].keys():
        np_data_dict[key] = np.array(
            [data_dict[key] for data_dict in list_data_dict], dtype=object
        )
        # if key != 'fbank':
